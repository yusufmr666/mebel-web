	...
	<aside id="fh5co-hero" class="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	...
		   	<li style="background-image: url(<?= base_url()?>assets/images/img_bg_4.jpg);">
		   		<div class="container">
		   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<div class="desc">
			...
			<?php foreach($produk->result() as $row):?>
				<div class="col-md-4 text-center animate-box">
					<div class="product">
						...
						<div class="desc">
							<h3><a href="<?= base_url('user/home/detail/' . $row->id_produk) ?>"><?=$row->nama?></a></h3>
	...
	<div class="modal fade" id="add<?= $row->id_produk?>" tabindex="-1" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<form method="POST" action="<?= base_url()?>user/home/cart" enctype="multipart/form-data">
			...
			<button type="submit"  onclick="getDate()" class="btn btn-primary">Save changes</button>
			</div>
			</form>
		</div>
		</div>
						...
						<div class="owl-carousel owl-carousel-fullwidth">
							<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="<?= base_url()?>assets/images/person1.jpg" alt="user">
									</figure>
							...
							<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="<?= base_url()?>assets/images/person2.jpg" alt="user">
									</figure>
							...
							<div class="item">
								<div class="testimony-slide active text-center">
									<figure>
										<img src="<?= base_url()?>assets/images/person3.jpg" alt="user">
									</figure>
									<span>John Doe, via <a href="#" class="twitter">Twitter</a></span>
									<blockquote>
	...
	<div id="fh5co-counter" class="fh5co-bg fh5co-counter" style="background-image:url(<?= base_url()?>assets/images/img_bg_5.jpg);">
		<div class="container">
			<div class="row">
				<div class="display-t">
